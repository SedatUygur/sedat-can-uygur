...
export const projects = [
    ...
    },
    {
        id: 3,
        name: 'Under Armour',
        description: 'Under Armour is obsessed with being better, stronger, and more focused than anyone else out there. To inspire you with performance solutions you never knew you needed and can’t imagine living without.',
        githubLink: '/',
    ...
    },
    {
        id: 4,
        name: 'Dropkick',
        description: 'Dropkick is a mobile app providing real‑time access to trending sneakers, apparel and accessories.',
        githubLink: '/',
    ...
    },
    {
        ...
        description: "Behind every branch, every leaf and every fruit is the promise of PortakalBahçem and our family's 100 years of farming experience. Reach the products we grow in PortakalBahçem terroir, located in Finike plain with its unique micro-climate in the world, from the source.",
        githubLink: '/',
