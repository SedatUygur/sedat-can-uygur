    ...
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Avatar.Root css={ringCss} colorPalette="pink" size="md">
        ...
        <section className="flex min-h-0 flex-col gap-y-3">
          ...
          <Card.Root className="bg-white">
              ...
              <div className="flex items-center justify-between gap-x-2 text-base">
                <h3 className="inline-flex items-center justify-center gap-x-1 font-semibold leading-none">
                  ...
                  <span className="inline-flex gap-x-1">
                    <Badge variant="solid" className="align-middle text-xs">
                      Remote
                    </Badge>
                  </span>
                </h3>
            ...
            <Card.Body className="mt-2 text-xs">
              <ul>
                <li>
          ...
          <Card.Root className="bg-white">
            <Card.Header>
              <div className="flex items-center justify-between gap-x-2 text-base">
                <h3 className="inline-flex items-center justify-center gap-x-1 font-semibold leading-none">
                  <a className="hover:underline" href="https://www.vodafone.com.tr">
                    Vodafone
                  </a>
                  <span className="inline-flex gap-x-1">
                    <Badge variant="solid" className="align-middle text-xs">
          ...
          <Card.Root className="bg-white">
            <Card.Header>
              <div className="flex items-center justify-between gap-x-2 text-base">
                <h3 className="inline-flex items-center justify-center gap-x-1 font-semibold leading-none">
                  <a className="hover:underline" href="https://www.kuzeypharma.com">
                    Kuzey Pharma
                  </a>
                  <span className="inline-flex gap-x-1">
                    <Badge variant="solid" className="align-middle text-xs">
              ...
              <h4 className="font-mono text-sm leading-none">Software Engineer</h4>
            </Card.Header>
            <Card.Body className="mt-2 text-xs">
              <ul>
                <li>
        ...
        <section className="flex min-h-0 flex-col gap-y-3">
          ...
          <Card.Root className="bg-white">
            ...
            <Card.Body className="mt-2">B.S. Computer Engineering</Card.Body>
          </Card.Root>
        </section>
        <section className="flex min-h-0 flex-col gap-y-3">
