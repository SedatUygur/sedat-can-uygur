  ...
  return (
    <div>
      <div className={styles.page}>
          ...
          <Link className={styles.workLink} href="/projects">{ctaTexts.landingCTA}</Link>
      </div>
      <div className={styles.homeWorkSection} id="work">
          ...
          <div style={{ textAlign: 'center', paddingBottom: '2rem' }}><Link className={styles.cta3} href="/projects">{ctaTexts.workCTA} <span>&gt;</span></Link></div>
      </div>
      ...
      <div id="about" className={styles.homeAboutSection}>
        ...
        <div data-aos="fade-up" style={{ textAlign: 'center', padding: '1rem 0', margin: '1rem 0', position: 'relative', display: 'flex' }}>
          ...
          <Link className={styles.cta4} href={userInfo.about.resume} target="_blank" style={{ alignItems: 'center', background: 'transparent', border: `2px solid`, display: 'flex' }}>{ctaTexts.resumeCTA}&nbsp;&nbsp;&nbsp;&nbsp;<FontAwesomeIcon width="15px" height="15px" icon={faGoogleDrive} /></Link>
        </div>
      </div>
    </div>
  );
